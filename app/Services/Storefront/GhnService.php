...
class GhnService
{
    ...
    {
        return $this->request('POST', '/shipping-order/fee', [
    ...
    {
        return $this->request('POST', '/shipping-order/create', [
            'payment_type_id' => 2,
    ...
    private function request(string $method, string $path, array $payload = [], string $responseKey = 'data', array $defaultList = []): array
    {
