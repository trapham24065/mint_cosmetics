...
var FullCalendar = (function (e) {
    ...
    constructor() {
      (super(...arguments),
        ...
        (this.handleEl = (e) => {
          ((this.el = e),
            this.props.elRef &&
              (Qn(this.props.elRef, e), e && this.didMountMisfire && this.componentDidMount()));
        }));
    }
    render() {
      const { props: e } = this,
  ...
  class Ni {
    ...
    today() {
      let e = this.getCurrentData();
      (this.unselect(),
        this.dispatch({ type: 'CHANGE_DATE', dateMarker: fr(e.calendarOptions.now, e.dateEnv) }));
    }
    gotoDate(e) {
      ...
      if (e instanceof ti) {
        ...
        return (
          this.getCurrentData().eventStore.defs[t.defId] ||
            (this.dispatch({ type: 'ADD_EVENTS', eventStore: Rr({ def: t, instance: n }) }),
    ...
    Po({
      ...
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            'datesSet',
            Object.assign(Object.assign({}, Di(e.activeRange, t.dateEnv)), { view: t.viewApi })
          );
        },
      ...
      class extends Mi {
        constructor(e) {
          (super(e),
            ...
            (this.handlePointerUp = (e) => {
              this.dragSelection &&
                (Yr(this.dragSelection, e, this.component.context), (this.dragSelection = null));
            }));
          let { component: t } = e,
            { options: n } = t.context,
            r = (this.dragging = new Fa(e.el));
        ...
        component: class extends ls {
          ...
          _eventStoreToSegs(e, t, n) {
            return this.eventRangesToSegs(
              ii(e, t, this.props.dateProfile.activeRange, this.context.options.nextDayThreshold)
                .fg,
              n
            );
          }
        ...
        p(
          ...
          p(
            ...
            p(
              'thead',
              { role: 'rowgroup' },
              p(_s, { dateProfile: e.dateProfile, dates: o.headerDates, datesRepDistinctDays: !1 })
            )
          )
        ),
        p(
