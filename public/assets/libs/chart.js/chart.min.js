...
!(function (t, e) {
  ...
  function F(t) {
    ...
    return (
      Array.isArray(t)
        ? t.length >= 3 &&
          ((e = { r: t[0], g: t[1], b: t[2], a: 255 }), t.length > 3 && (e.a = c(t[3])))
  ...
  class V {
    ...
    rgbString() {
      return this._valid
        ? (t = this._rgb) &&
            (t.a < 255 ? `rgba(${t.r}, ${t.g}, ${t.b}, ${d(t.a)})` : `rgb(${t.r}, ${t.g}, ${t.b})`)
        : void 0;
      var t;
    }
    hexString() {
  ...
  const Re = (t, e) => (t ? t + dt(e) : e),
    Ee = (t, e) =>
      q(e) && 'adapters' !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
  function Ie(t, e, i) {
      ...
      (function (t, e) {
        ...
        for (i = 0, s = t.length; i < s; ++i)
          ((a = o),
            ...
            o &&
              ((n = t[i]),
              a && ((n.cp1x = Ke(n.cp1x, e.left, e.right)), (n.cp1y = Ke(n.cp1y, e.top, e.bottom))),
              r &&
                ((n.cp2x = Ke(n.cp2x, e.left, e.right)), (n.cp2y = Ke(n.cp2y, e.top, e.bottom)))));
      })(t, i);
  }
  const Ze = (t) => 0 === t || 1 === t,
    ...
    ti = {
      ...
      easeInOutBounce: (t) =>
        t < 0.5 ? 0.5 * ti.easeInBounce(2 * t) : 0.5 * ti.easeOutBounce(2 * t - 1) + 0.5,
    };
  function ei(t, e, i, s) {
      ...
      ((m = e[t % a]),
        m.skip ||
          ...
          p !== b &&
            ...
            null !== _ &&
              v() &&
              (g.push(vi({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)),
            (i = t),
            (b = p))));
  ...
  function ds(t) {
    return !ie() || ('undefined' != typeof OffscreenCanvas && t instanceof OffscreenCanvas)
      ? Gi
      : cs;
  }
  ...
  class Os {
    ...
    parseObjectData(t, e, i, s) {
      ...
      let h, c, d, u;
      for (h = 0, c = s; h < c; ++h)
        ((d = h + i), (u = e[d]), (l[h] = { x: n.parse(ct(u, a), d), y: o.parse(ct(u, r), d) }));
      return l;
    }
    getParsed(t) {
    ...
    getMinMax(t, e) {
      const i = this._cachedMeta,
        ...
        r = ((t, e, i) => t && !e.hidden && e._stacked && { keys: _s(i, !0), values: null })(
          e,
          i,
          this.chart
        ),
    ...
    _update(t) {
      ...
      (this.update(t || 'default'),
        (e._clip = (function (t) {
          let e, i, s, n;
          return (
            q(t) ? ((e = t.top), (i = t.right), (s = t.bottom), (n = t.left)) : (e = i = s = n = t),
  ...
  class Ns extends As {
    ...
    update(t, e, i) {
      ...
      (this._convertTicksToLabels(r ? zs(this.ticks, a) : this.ticks),
        ...
        o.display &&
          ...
          ((this.ticks = Rs(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
    ...
    getContext(t) {
      ...
      return (
        this.$context ||
        (this.$context = mi(this.chart.getContext(), { scale: this, type: 'scale' }))
      );
    }
    _tickSize() {
    ...
    drawBorder() {
      ...
      let r, l, h, c;
      (this.isHorizontal()
        ? ((r = xe(t, this.left, n) - n / 2), (l = xe(t, this.right, o) + o / 2), (h = c = a))
        : ((h = xe(t, this.top, n) - n / 2), (c = xe(t, this.bottom, o) + o / 2), (r = l = a)),
        e.save(),
    ...
    drawTitle() {
      ...
      'bottom' === e || 'center' === e || q(e)
        ? ((l += a.bottom), X(i.text) && (l += o.lineHeight * (i.text.length - 1)))
        : (l += a.top);
      const {
        titleX: h,
        titleY: c,
  ...
  function cn(t) {
    return (
      ie() && 'string' == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]),
      ...
      (e &&
        ...
        et(n, (e) => {
          ...
          if (o in i && i[o].type === r) l = i[o];
            ...
            ((l = new (Hs.getScale(r))({ id: o, type: r, ctx: this.ctx, chart: this })),
              (i[l.id] = l));
          }
          l.init(n, t);
        }),
  ...
  function wn(t, e, i, s) {
    ...
    let h, c, d, u;
    for (h = i, c = i + s; h < c; ++h)
      ((u = e[h]), (d = {}), (d[n.axis] = r || n.parse(a[h], h)), l.push(vn(u, d, o, h)));
    return l;
  }
  function Mn(t) {
  ...
  function Sn(t, e, i, s) {
    ...
    return (
      s
        ? ((a = i), (t = Pn((t = (n = t) === (o = e) ? a : n === a ? o : n), i, e)))
        : (t = Pn(t, e, i)),
      t
    );
  }
  ...
  class Cn extends Os {
    ...
    parseObjectData(t, e, i, s) {
      ...
      let d, u, f, g;
      for (d = i, u = i + s; d < u; ++d)
        ((g = e[d]), (f = {}), (f[n.axis] = n.parse(ct(g, l), d)), c.push(vn(ct(g, h), f, o, d)));
      return c;
    }
    updateRangeFromParsed(t, e, i, s) {
    ...
    _getStacks(t, e) {
      ...
      for (const i of s)
        if (
          (void 0 === e || !a(i)) &&
          ((!1 === n || -1 === o.indexOf(i.stack) || (void 0 === n && void 0 === i.stack)) &&
            o.push(i.stack),
          i.index === t)
        )
          break;
    ...
    update(t) {
      ...
      let { start: a, count: r } = (function (t, e, i) {
        ...
        if (t._sorted) {
          ...
          (d &&
            (n = Qt(
              Math.min(wt(r, a.axis, h).lo, i ? s : wt(e, l, a.getPixelForValue(h)).lo),
              0,
              s - 1
            )),
            (o = u
              ? Qt(
                  Math.max(wt(r, a.axis, c).hi + 1, i ? 0 : wt(e, l, a.getPixelForValue(c)).hi + 1),
                  n,
                  s
                ) - n
              : s - n));
    ...
    updateElements(t, e, i, s) {
      ...
      for (let f = e; f < e + i; ++f) {
        const e = t[f],
          ...
          v = (x[u] =
            n || _ ? a.getBasePixel() : a.getPixelForValue(r ? this.applyStack(a, i, r) : i[u], f));
  ...
  function Fn(t, e, i) {
    ...
    (t.beginPath(),
      t.arc(o, a, r, s - h, i + h),
      l > n ? ((h = n / l), t.arc(o, a, l, i + h, s - h, !0)) : t.arc(o, a, n, i + Et, s - Et),
      t.closePath(),
      t.clip());
  }
  function Bn(t, e, i, s) {
    ...
    a &&
      ...
      e.fullCircles &&
        (function (t, e, i) {
          ...
          let c;
          for (
            i && Fn(t, e, o + At), t.beginPath(), t.arc(s, n, h, o + At, o, !0), c = 0;
            c < r;
            ++c
          )
            t.stroke();
    ...
    _getLegendItemAt(t, e) {
      ...
      if (ee(t, this.left, this.right) && ee(e, this.top, this.bottom))
        for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
          if (((s = n[i]), ee(t, s.left, s.left + s.width) && ee(e, s.top, s.top + s.height)))
  ...
  class Zo extends Ns {
    ...
    parse(t, e) {
      ...
      return ((t, e) => (null === t ? null : Qt(Math.round(t), 0, e)))(
        (e = isFinite(e) && i[e] === t ? e : Go(i, t, Z(e, t), this._addedLabels)),
        i.length - 1
      );
    }
    determineDataLimits() {
  ...
  ((ia.id = 'logarithmic'),
    (ia.defaults = { ticks: { callback: Ls.formatters.logarithmic, major: { enabled: !0 } } }));
  class da extends Qo {
    constructor(t) {
      (super(t),
        (this.xCenter = void 0),
            ...
            for (let n = e - 1; n >= 0; n--) {
              ...
              if (!U(f)) {
                ...
                Object.values(t).some((t) => 0 !== t)
                  ? (i.beginPath(), Oe(i, { x: n, y: o, w: a, h: r, radius: t }), i.fill())
                  : i.fillRect(n, o, a, r);
              }
  ...
  function pa(t, e) {
    ...
    return (
      ...
      null === a
        ...
        : (n &&
            (a =
              'week' !== n || (!Nt(o) && !0 !== o) ? i.startOf(a, n) : i.startOf(a, 'isoWeek', o)),
          +a)
    );
  }
  function ma(t, e, i, s) {
  ...
  function ya(t, e, i) {
    ...
    i
      ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = wt(t, 'pos', e)),
        ({ pos: s, time: o } = t[r]),
        ({ pos: n, time: a } = t[l]))
      : (e >= t[r].time && e <= t[l].time && ({ lo: r, hi: l } = wt(t, 'time', e)),
        ({ time: s, pos: o } = t[r]),
        ({ time: n, pos: a } = t[l]));
    const h = n - s;
