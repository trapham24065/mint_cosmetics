...
(function (g, k) {
  ...
  var b = {
      ...
      addClass: function (a, c) {
        b.hasClass(a, c) ||
          (a.classList ? a.classList.add(c) : (a.className = a.className.trim() + ' ' + c));
      },
    ...
    p = function () {
      if (this.items.length) {
        ...
        a.childElementCount &&
          ...
          (this.navIndex = (
            a.querySelector('.selectr-option.selected') || a.querySelector('.selectr-option')
          ).idx),
        ...
        if (
          ...
          if (' ' === b.key || (!a.opened && -1 < ['Enter', 'ArrowUp', 'ArrowDown'].indexOf(b.key)))
            ...
            if (a.config.multiple)
              (a.open(),
                a.config.searchable &&
                  ((a.input.value = b.key), a.input.focus(), a.search(null, !0)));
            else {
              e += b.key;
              var c = a.search(e, !0);
    ...
    if (this.el.multiple) {
      ...
      b.each(
        ...
        function (c, d) {
          var e = this.items[c];
          c !== a &&
            (e && b.removeClass(e, 'selected'), (d.selected = !1), d.removeAttribute('selected'));
        },
        this
      );
    }
