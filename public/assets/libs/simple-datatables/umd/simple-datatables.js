              ...
              function b(t, e, s) {
                ...
                switch (o) {
                  ...
                  case s._const.addElement:
                    ...
                    i.insertBefore(
                      m(e[s._const.element], 'http://www.w3.org/2000/svg' === i.namespaceURI, s),
                      i.childNodes[c] || null
                    );
                    break;
                ...
                H = function (t, e) {
                  ...
                  return (
                    t.replace(T, function (r, l) {
                      ...
                      if (d) {
                        if (
                          ('svg' === (s = R(r, e.caseSensitive || o)).node.nodeName && (o = !0),
                          n++,
                          !s.voidElement && u && '<' !== u)
                        ) {
                    ...
                    (t.prototype.findDiffs = function (t, e) {
                      ...
                      do {
                        ...
                        (0 === (s = this.findNextDiff(t, e, [])).length &&
                          ...
                          s.length > 0 &&
                            ((this.foundAll = !1), this.tracker.add(s), S(t, s, this.options)));
                      } while (s.length > 0);
                            ...
                            if ('#text' === (l = f[_]).nodeName)
                              if ('#text' === m[v].nodeName) {
                                if (l.data !== m[v].data) {
                                  for (
                                    var w = _;
                                    f.length > w + 1 && '#text' === f[w + 1].nodeName;
                ...
                q = (
                  ...
                  if (((M.attributes.class = c(M.attributes.class, r.table)), d || h || w)) {
                    ...
                    if (d || w) {
                      ...
                      ((!f.length && !l) || _ || (e.attributes = { style: 'height: 0px;' }),
                            ...
                            (this.$d = (function (t, e, s) {
                              try {
                                ...
                                var b = r || 0,
                                  ...
                                  w = c || 0;
                                return h
                                  ? new Date(Date.UTC(m, g, f, b, v, _, w + 60 * h.offset * 1e3))
                                  : s
                      ...
                      (Object.entries(e).forEach(([e, s]) => {
                        ...
                        a > -1
                          ...
                          : this.hasHeadings ||
                            this.hasRows ||
                            0 !== i ||
                            ((n[t.length] = X(s, this.columns.settings[t.length])),
                            t.push(e),
