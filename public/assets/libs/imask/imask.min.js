!(function (t, e) {
  ...
  function p(t) {
    ...
    if (o.Masked) {
      ...
      const { mask: e, ...a } =
        t instanceof o.Masked ? { mask: t } : s(t) && t.mask instanceof o.Masked ? t : {};
      if (e) {
        const t = e.mask;
  ...
  class C {
    ...
    _appendChar(t, e, s) {
      ...
      if (
        ...
        t &&
          ((a = a.aggregate(this._appendCharRaw(t, e))), !a.rawInserted && 'pad' === this.autofix))
      ) {
        const s = this.state;
        this.state = i;
        let u = this.pad(e);
    ...
    appendTo(t) {
      ...
      for (let s = 0; s < this.chunks.length; ++s) {
        ...
        if (
          (null != u &&
            (!a || a.index <= u) &&
            ((i instanceof A || t._stops.indexOf(u) >= 0) && e.aggregate(t._appendPlaceholder(u)),
  ...
  class F {
    ...
    pushLeftBeforeFilled() {
      return this._pushLeft(() => {
        if (!this.block.isFixed && this.block.value)
          return (
            (this.offset = this.block.nearestInputPos(this.offset, a.FORCE_LEFT)),
    ...
    pushRightBeforeFilled() {
      return this._pushRight(() => {
        if (!this.block.isFixed && this.block.value)
          return (
            (this.offset = this.block.nearestInputPos(this.offset, a.FORCE_RIGHT)),
    ...
    _appendCharRaw(t, e) {
      ...
      for (let u, n = s.index; (u = this._blocks[n]); ++n) {
        ...
        const s = u._appendChar(t, {
          ...e,
          _beforeTailState:
            null == (a = e._beforeTailState) || null == (a = a._blocks) ? void 0 : a[n],
        });
        ...
        ? (s.pushRightBeforeInput(),
          ...
          s.pushRightBeforeFilled()
            ...
            : e === a.FORCE_RIGHT
              ...
              : (s.popState(),
                s.ok ? s.pos : (s.popState(), s.ok ? s.pos : this.nearestInputPos(t, a.LEFT))))
        : t;
    }
    totalInputPositions(t, e) {
      (void 0 === t && (t = 0), void 0 === e && (e = this.displayValue.length));
  ...
  class D extends b {
    ...
    _update(t) {
      ...
      ((u.mask = r.slice(0, h).replace(/0/g, '\\0') + '0'.repeat(this.maxLength - h)),
        super._update(u));
    }
    get isComplete() {
          ...
          return (
            ...
            n.appendTail(i),
            {
              ...
              totalInputPositions: n.totalInputPositions(
                0,
                Math.max(o, n.nearestInputPos(n.displayValue.length, a.FORCE_LEFT))
              ),
            }
          );
        });
  ...
  class I extends b {
    ...
    remove(t, e) {
      ...
      let i;
      for (i = t; i >= 0; --i) {
        if (this.enum.filter((t) => this.matchValue(t, this.value.slice(s, i), s)).length > 1)
          break;
      }
  ...
  class w extends C {
    ...
    _appendCharRaw(t, e) {
      ...
      if (r) {
        ...
        (null != this.min && this.min < 0 && this.number < this.min && (t = this.min),
          ...
          null != t &&
            (this.autofix
              ? ((this._value = this.format(t, this).replace(w.UNMASKED_RADIX, this.radix)),
                h || (h = a === this._value && !e.tail))
              : (r = !1)),
          r && (r = Boolean(this._value.match(this._numberRegExp))));
      }
      (r
        ? (n = new v({ inserted: this._value.slice(a.length), rawInserted: h ? '' : t, skip: h }))
    ...
    doSkipInvalid(t, e, s) {
      ...
      const i =
        ...
        (t === this.radix || t === w.UNMASKED_RADIX || this.mapToRadix.includes(t));
    ...
    typedValueEquals(t) {
      return (
        (super.typedValueEquals(t) ||
          (w.EMPTY_VALUES.includes(t) && w.EMPTY_VALUES.includes(this.typedValue))) &&
        !(0 === t && '' === this.value)
      );
    }
  }
  ...
  class L extends b {
    get repeatFrom() {
      var t;
      return null !=
        (t = Array.isArray(this.repeat) ? this.repeat[0] : this.repeat === 1 / 0 ? 0 : this.repeat)
        ? t
        : 0;
    }
    get repeatTo() {
    ...
    _update(t) {
      ...
      ((this.repeat =
        null != (e = null != (s = null != a ? a : n.repeat) ? s : this.repeat) ? e : 1 / 0),
        super._update({
          mask: 'm'.repeat(
            Math.max(
              (this.repeatTo === 1 / 0 && (null == (i = this._blocks) ? void 0 : i.length)) || 0,
              this.repeatFrom
            )
          ),
          blocks: { m: n },
    ...
    _appendCharRaw(t, e) {
      ...
      for (
        ...
        const l = r._appendChar(t, {
          ...e,
          _beforeTailState:
            null == (n = e._beforeTailState) || null == (n = n._blocks) ? void 0 : n[o],
        });
        if (l.skip && h) {
    ...
    _trimEmptyTail(t, e) {
      ...
      let u;
      (null != e && (u = null == (i = this._mapPosToBlock(e)) ? void 0 : i.index),
