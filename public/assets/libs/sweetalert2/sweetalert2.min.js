            ...
            (function (t, e, n, o) {
              ...
              (rt([t, e, n], w.styled),
                o.confirmButtonColor &&
                  ((t.style.backgroundColor = o.confirmButtonColor), rt(t, w['default-outline'])));
              o.denyButtonColor &&
                ((e.style.backgroundColor = o.denyButtonColor), rt(e, w['default-outline']));
              o.cancelButtonColor &&
                ((n.style.backgroundColor = o.cancelButtonColor), rt(n, w['default-outline']));
            })(o, i, r, n),
            n.reverseButtons &&
              (n.toast
  ...
  var xt = function (t, e) {
    ...
    n &&
      ...
      (function (t, e) {
        ...
        e in w
          ? rt(t, w[e])
          : (E('The "position" parameter is not valid, defaulting to "center"'), rt(t, w.center));
      })(n, e.position),
      (function (t, e) {
        if (!e) return;
  ...
  var _t = function (t, e) {
    ...
    Wt = function (t, e) {
      ...
      ((t.className = ''.concat(w.popup, ' ').concat(mt(t) ? n.popup : '')),
        e.toast
          ? (rt([document.documentElement, document.body], w['toast-shown']), rt(t, w.toast))
          : rt(t, w.modal),
        et(t, e, 'popup'),
