var slider = document.getElementById('slider'),
  hidingTooltipSlider =
    (noUiSlider.create(slider, { start: [5], step: 1, range: { min: [0], max: [10] } }),
...
var html5Slider = document.getElementById('html5'),
  inputNumber =
    (noUiSlider.create(html5Slider, { start: [10, 30], connect: !0, range: { min: -20, max: 40 } }),
...
for (i = 0; i < pips.length; i++)
  ((pips[i].style.cursor = 'pointer'), pips[i].addEventListener('click', clickOnPip));
