        ...
        s(n, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (Object.assign(o.style, { width: '', height: '', maxWidth: '', maxHeight: '' }),
              ...
              if (
                (l &&
                  ...
                  (this.viewport = i(i({}, this.viewport), {}, { width: u, height: f }))),
          ...
          },
          {
            ...
            value: function () {
              ...
              ((this.$viewport =
                ...
                this.$container.querySelector('.'.concat(i).concat(n.viewport))),
              this.$viewport) ||
              ...
              value: function () {
                if (t.Fancybox && !t.Fancybox.getInstance()) {
                  ...
                  if (n) {
                    ...
                    if (
                      (a &&
                        a.dispatchEvent(new CustomEvent('click', { bubbles: !0, cancelable: !0 })),
                      !t.Fancybox.getInstance())
                    ) {
                      var s = document.querySelectorAll('[data-fancybox="'.concat(n, '"]'));
                      s.length &&
                        (null === o && 1 === s.length ? (a = s[0]) : o && (a = s[o - 1]),
                        a &&
                          a.dispatchEvent(
                  ...
                  if (n) {
                    ...
                    for (
                      ...
                      !c.offsetParent || (!h && this.Carousel.$viewport.contains(c))
                        ...
                        : (s.push(c),
                          void 0 !== c.dataset.origTabindex &&
                            ((c.tabIndex = c.dataset.tabindex), c.removeAttribute('data-tabindex')),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return (
                  ...
                  ((a = s ? o.indexOf(s) : a),
                  new i((o = o.map(n)), x({}, e, { startIndex: a, $trigger: s })))
                );
              },
            },
            {
