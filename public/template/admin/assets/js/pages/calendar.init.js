document.addEventListener('DOMContentLoaded', function () {
  ...
  new FullCalendar.Calendar(e, {
    ...
    selectable: !0,
    events: [
      { title: 'Business Lunch', start: '2024-06-03T13:00:00', constraint: 'businessHours' },
      { title: 'Meeting', start: '2024-06-13T11:00:00', constraint: 'availableForMeeting' },
      ...
      { start: '2024-06-06', end: '2024-06-08', overlap: !1, title: 'New Event' },
    ],
  }).render();
});
