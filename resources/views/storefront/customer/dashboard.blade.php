                            ...
                            <div class="myaccount-content">
                                ...
                                <div class="account-details-form">
                                    <form action="{{ route('customer.profile.update') }}" method="POST"
                                        ...
                                        @csrf
                                        @method('PUT')
                                        <input type="text" name="profile_fake_username" autocomplete="username"
                                            class="d-none" tabindex="-1" aria-hidden="true">
                                        <input type="password" name="profile_fake_password" autocomplete="new-password"
                                            class="d-none" tabindex="-1" aria-hidden="true">
                                        <div class="row">
                                            <div class="col-lg-6">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body reason-modal-body">
                ...
                <p id="modal-reason" class="reason-modal-text"></p>

                <div id="modal-description-wrapper" style="display:none;">
                    <p><strong>Mô tả chi tiết:</strong></p>
                    <p id="modal-description" class="reason-modal-text"></p>
                </div>

                <div id="modal-admin-note-wrapper" style="display:none;">
                    <p><strong>Phản hồi từ shop:</strong></p>
                    <p id="modal-admin-note" class="text-danger mb-0 reason-modal-text"></p>
                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        reasonModal.addEventListener('show.bs.modal', function(event) {
            ...
            var adminNote = trigger.getAttribute('data-admin-note');
            ...
            if (adminNote) {
                document.getElementById('modal-admin-note').textContent = adminNote;
                document.getElementById('modal-admin-note-wrapper').style.display = 'block';
            } else {
                document.getElementById('modal-admin-note-wrapper').style.display = 'none';
            }
