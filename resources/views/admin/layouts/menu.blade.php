            ...
            @if(auth()->user()->isAdmin() || auth()->user()->isSale())
                <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarOrders">
                        <ul class="nav sub-navbar-nav">
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href="{{route('admin.orders.index')}}">Danh sách đơn hàng</a>
                            </li>
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href="{{route('admin.returns.index')}}">Quản lý trả hàng</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="sidebarCustomers">
                        <ul class="nav sub-navbar-nav">
                            ...
                            <li class="sub-nav-item">
                                <a class="sub-nav-link" href="{{ route('admin.contacts.index') }}">Liên hệ</a>
                            </li>
                        </ul>
                    </div>
                </li>
