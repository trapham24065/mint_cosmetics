    ...
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-7 col-md-7">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="table-supplier-orders-gridjs" data-url="{{ route('admin.api.suppliers.orders.data', $supplier) }}"></div>
                </div>
            </div>
        </div>
    </div>
        ...
        new gridjs.Grid({
            columns: [{
                ...
                },
                {
                    id: 'total_amount',
                    name: 'Tổng tiền',
                    formatter: (cell) => gridjs.html(`<span class="fw-bold">${Number(cell).toLocaleString('vi-VN')}</span>`)
                },
                {
                    name: 'Hành động',
                    sort: false,
