                                ...
                                <table class="table align-middle mb-0 table-hover table-centered">
                                    ...
                                    <tfoot class="bg-light-subtle border-top">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-end">{{ number_format((float) $order->shipping_fee, 0, ',', '.') }} VNĐ</th>
                                        </tr>
                                        <tr>
                                            <th colspan="3" class="text-end">Tổng cộng</th>
                                            <th class="text-end">{{ number_format($order->total_price, 0, ',', '.') }} VNĐ</th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
        ...
        <div class="col-xl-3 col-lg-4">
                        ...
                        <table class="table mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end text-dark fw-medium px-0">{{ number_format($subtotal, 0, ',', '.') }} VNĐ</td>
                                </tr>
                                <tr class="border-top">
                                    <td class="px-0">
                                        <p class="fw-medium text-dark mb-0">Phí GHN</p>
                                    </td>
                                    <td class="text-end text-dark fw-medium px-0">{{ number_format((float) $order->shipping_fee, 0, ',', '.') }} VNĐ</td>
                                </tr>
                                <tr class="border-top">
                                    <td class="px-0">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-1"><strong>Đơn vị vận chuyển:</strong> {{ strtoupper($order->shipping_provider ?? 'N/A') }}</p>
                    <p class="mb-1"><strong>Mã đơn GHN:</strong> {{ $order->ghn_order_code ?? 'Chưa tạo' }}</p>
                    <p class="mb-1"><strong>Phí GHN:</strong> {{ number_format((float) $order->shipping_fee, 0, ',', '.') }} VNĐ</p>
                    <p class="mb-1"><strong>GHN District:</strong> {{ $order->shipping_district_id ?? 'N/A' }}</p>
                    <p class="mb-1"><strong>GHN Ward:</strong> {{ $order->shipping_ward_code ?? 'N/A' }}</p>
                </div>
            </div>
        </div>
    </div>
