        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Associated Keywords</h4>
                </div>
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                            ...
                            <button type="button"
                                class="btn btn-sm btn-outline-danger p-1 lh-1 delete-item"
                                data-id="{{ $keyword->id }}"
                                data-name="{{ $keyword->keyword }}"
                                data-url="{{ route('admin.chatbot-keywords.destroy', $keyword) }}">&times;
                            </button>
                        </div>
                        @empty
...
<script>
    AdminCRUD.initDeleteHandler('.delete-item', {
        confirmTitle: 'Xóa từ khóa?',
        confirmText: 'Bạn sắp xóa từ khóa:'
    });
</script>
@endpush