                        ...
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select
                                            ...
                                            @foreach ($parentCategories as $parentCategory)
                                                <option
                                                    value="{{ $parentCategory->id }}" @selected((int) old('parent_id', $category->parent_id) === $parentCategory->id)>{{ trim($parentCategory->hierarchy_name) }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="hidden" name="remove_current_image" id="remove-current-category-image"
                                           value="{{ old('remove_current_image', '0') }}">
                                    @error('image')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                        ...
                                        <div class="d-flex align-items-start gap-3">
                                            ...
                                            <div>
                                                ...
                                                <button type="button" id="remove-category-image-btn"
                                                        class="btn btn-sm btn-outline-danger mt-2">Xóa ảnh hiện tại
                                                </button>
                                            </div>
                                        </div>
                                    </div>
