            ...
            <div class="col-xl-9 col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="number" id="stock" name="stock"
                                           ...
                                           value="0" readonly>
                                    <small class="text-muted">Stock is managed via Inventory Purchase Orders.
                                        Initial stock is 0.</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="gallery-images" class="form-label">Image Gallery (Optional)</label>
        ...
        function renderVariantForms (combinations) {
            ...
            combinations.forEach((combo, index) => {
                ...
                <div class="col-md-12 mb-2">
                             ...
                             <input type="text" name="variants[${index}][sku]" class="form-control form-control-sm" value="${variantSku}" placeholder="Variant SKU">
                                        </div>
