        ...
        <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" novalidate>
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="card">
                        <div class="card-header"><h4 class="card-title">Loại sản phẩm</h4></div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header"><h4 class="card-title">Thông tin sản phẩm</h4></div>
                        <div class="card-body">
                            <div class="row">
                    ...
                    <div id="simple-product-fields">
                        <div class="card">
                            <div class="card-header"><h4 class="card-title">Giá cả & Hàng tồn kho</h4></div>
                            <div class="card-body">
                                <div class="row">
                    ...
                    <div id="variable-product-fields" style="display: none;">
                        <div class="card">
                            <div class="card-header"><h4 class="card-title">Các biến thể sản phẩm</h4></div>
                            <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header"><h4 class="card-title">Hình ảnh sản phẩm</h4></div>
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="main-image" class="form-label">Hình ảnh chính</label>
                            ...
                            <div class="mb-3">
                                <label for="gallery-images" class="form-label">Bộ sưu tập hình ảnh (Tùy chọn)</label>
