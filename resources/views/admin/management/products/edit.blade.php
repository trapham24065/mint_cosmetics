                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select
                                        ...
                                        @foreach($categories as $cat)
                                            <option
                                                value="{{ $cat->id }}" @selected((int) old('category_id', $product->category_id ?? 0) === $cat->id)>{{ trim($cat->hierarchy_name) }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    @if($product->category && $product->category->children()->exists())
                                        <small class="text-warning d-block mt-1">
                                            Danh mục hiện tại đã có danh mục con. Bạn vẫn có thể lưu để chỉnh sửa thông
                                            tin,
                                            nhưng nên chuyển sản phẩm sang danh mục con phù hợp.
                                        </small>
                                    @endif
