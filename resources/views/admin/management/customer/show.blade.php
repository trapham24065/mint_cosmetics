        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-5 col-md-5">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        <img src="{{ asset('assets/storefront/images/users/dummy-avatar.jpg') }}"
                             alt="user-avatar"
                        ...
                        <span class="badge bg-{{ $customer->status ? 'success' : 'danger' }} px-3 py-2">
                            {{ $customer->status ? 'Hoạt động' : 'Bị chặn' }}
                        </span>
                        </div>
                    </div>
                    <hr class="my-0">
            ...
            <div class="col-xl-8 col-lg-7 col-md-7">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="table-customer-orders-gridjs"
                             data-url="{{ route('admin.api.customers.orders.data', $customer) }}"></div>
                    </div>
                </div>
            </div>
        </div>
